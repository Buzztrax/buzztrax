...
static void init() {
  ...
  gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scrolled_window1),GTK_SHADOW_NONE);
  ...
  gtk_box_pack_start(GTK_BOX(box), GTK_WIDGET(scrolled_window1), FALSE, FALSE, 0);
  ...
  gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scrolled_window2),GTK_SHADOW_NONE);
  ...
  gtk_box_pack_start(GTK_BOX(box), GTK_WIDGET(scrolled_window2), TRUE, TRUE, 0);
