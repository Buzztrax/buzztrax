...
static void
on_page_switched (GtkNotebook * notebook, GtkNotebookPage * page,
...
static void
add_page (GtkNotebook * notebook, const gchar * name)
{
...
init ()
{
  ...
  g_signal_connect (notebook, "switch-page", G_CALLBACK (on_page_switched),
      NULL);
