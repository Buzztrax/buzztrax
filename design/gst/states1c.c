/** $Id: states1c.c,v 1.2 2006-09-16 16:28:13 ensonic Exp $
...
static gint64 query_and_print(GstElement *element, GstQuery *query) {
  gint64 pos=0;
...
int main(int argc, char **argv) {
  ...
  /* prepare playing */
  if(gst_element_set_state (bin, GST_STATE_READY)==GST_STATE_CHANGE_FAILURE) {
