 ...
 *
 * gcc -Wall -g dynlink3.c -o dynlink3-0.10 `pkg-config gstreamer-0.10 --cflags --libs`
 * gcc -Wall -g -DGST_USE_UNSTABLE_API dynlink3.c -o dynlink3-0.11 `pkg-config gstreamer-0.11 --cflags --libs`
