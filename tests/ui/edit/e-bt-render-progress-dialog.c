...
BT_START_TEST(test_create_dialog) {
  ...
  BtRenderDialog *render_settings;
  GtkWidget *dialog;
  ...
  gtk_widget_destroy(GTK_WIDGET(render_settings));
...
TCase *bt_render_progress_dialog_example_case(void) {
  TCase *tc = tcase_create("BtRenderProgressDialogExamples");
