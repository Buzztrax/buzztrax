/* $Id: e-bt-machine-preset-properties-dialog.c,v 1.1 2007-01-13 19:47:17 ensonic Exp $
 *
 * Buzztard
...
BT_START_TEST(test_create_dialog) {
  ...
  dialog=GTK_WIDGET(bt_machine_preset_properties_dialog_new(app,&name,&comment));
