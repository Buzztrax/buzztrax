...
m4_define(`__DATE_CHANGED',`Thu Dec 18 17:07:20 MET 2003')
  ...
  <body bgcolor="#FFFFFF">
		...
		<div id="main">
			...
			<p align="justify">
				...
				auto* structure and some code.
				It looks like <a href="http://gstreamer.freedesktop.org/" target="_new">gstreamer</a>
			...
			<p align="justify">
				...
				<ol>
					<li><b>song network via gstreamer</b> (ensonic)<br>
						I can create simple pipelines/threads. Further the examples can
