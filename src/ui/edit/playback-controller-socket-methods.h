/* $Id: playback-controller-socket-methods.h,v 1.1 2007-03-06 21:58:51 ensonic Exp $
 *
 * Buzztard
...
#ifndef BT_PLAYBACK_CONTROLLER_SOCKET_METHODS_H
#define BT_PLAYBACK_CONTROLLER_SOCKET_METHODS_H
