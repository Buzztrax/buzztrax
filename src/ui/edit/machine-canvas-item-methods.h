/* $Id: machine-canvas-item-methods.h,v 1.1 2004-12-13 07:52:27 ensonic Exp $
...
extern BtMachineCanvasItem *bt_machine_canvas_item_new(BtMainPageMachines *main_page_machines,BtMachine *machine,gdouble xpos,gdouble ypos,gdouble zoom);
