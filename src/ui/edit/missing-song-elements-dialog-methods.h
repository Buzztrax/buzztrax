/* $Id: missing-song-elements-dialog-methods.h,v 1.1 2007-07-19 20:39:05 ensonic Exp $
 *
 * Buzztard
...
#ifndef BT_MISSING_SONG_ELEMENTS_DIALOG_METHODS_H
#define BT_MISSING_SONG_ELEMENTS_DIALOG_METHODS_H
