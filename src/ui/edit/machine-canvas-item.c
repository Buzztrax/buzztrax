...
static void
on_machine_parent_changed (GstObject * object, GstObject * parent,
    gpointer user_data)
{
  ...
  switch (property_id) {
    ...
    case MACHINE_CANVAS_ITEM_MACHINE:{
      ...
      if (self->priv->machine) {
        ...
        g_signal_connect (self->priv->machine, "parent-set",
            G_CALLBACK (on_machine_parent_changed), (gpointer) self);
        g_signal_connect (self->priv->machine, "parent-unset",
            G_CALLBACK (on_machine_parent_changed), (gpointer) self);
...
bt_machine_canvas_item_realize (GnomeCanvasItem * citem)
{
  ...
  GNOME_CANVAS_ITEM_CLASS (bt_machine_canvas_item_parent_class)->
      realize (citem);
...
bt_machine_canvas_item_class_init (BtMachineCanvasItemClass * klass)
{
  ...
  g_object_class_install_property (gobject_class, MACHINE_CANVAS_ITEM_MACHINES_PAGE, g_param_spec_object ("machines-page", "machines-page contruct prop", "Set application object, the window belongs to", BT_TYPE_MAIN_PAGE_MACHINES,  /* object type */
#ifndef GNOME_CANVAS_BROKEN_PROPERTIES
          G_PARAM_CONSTRUCT_ONLY |
#endif
          G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));

  g_object_class_install_property (gobject_class, MACHINE_CANVAS_ITEM_MACHINE, g_param_spec_object ("machine", "machine contruct prop", "Set machine object, the item belongs to", BT_TYPE_MACHINE,     /* object type */
#ifndef GNOME_CANVAS_BROKEN_PROPERTIES
          G_PARAM_CONSTRUCT_ONLY |
#endif
          G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
