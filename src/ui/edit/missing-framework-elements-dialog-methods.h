/* $Id: missing-framework-elements-dialog-methods.h,v 1.1 2007-04-01 16:18:22 ensonic Exp $
 *
 * Buzztard
...
#ifndef BT_MISSING_FRAMEWORK_ELEMENTS_DIALOG_METHODS_H
#define BT_MISSING_FRAMEWORK_ELEMENTS_DIALOG_METHODS_H
