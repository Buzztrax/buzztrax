...
/**
 * SECTION:bthruler
 * @Short_description: A horizontal ruler
 * @Title: BtHRuler
 *
 * <note>
...
G_DEFINE_TYPE (BtHRuler, bt_hruler, BT_TYPE_RULER)

static void
bt_hruler_class_init (BtHRulerClass *klass)
{
}

static void
bt_hruler_init (BtHRuler *hruler)
{
 ...
 *
 * Returns: a new #BtHRuler.
 */
GtkWidget *
bt_hruler_new (void)
{
  return g_object_new (BT_TYPE_HRULER, NULL);
}
