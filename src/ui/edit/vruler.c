...
G_DEFINE_TYPE (BtVRuler, bt_vruler, BT_TYPE_RULER)

static void
bt_vruler_class_init (BtVRulerClass *klass)
{
}

static void
bt_vruler_init (BtVRuler *vruler)
{
 ...
 *
 * Returns: a new #BtVRuler.
 */
GtkWidget *
bt_vruler_new (void)
{
  return g_object_new (BT_TYPE_VRULER, NULL);
}
