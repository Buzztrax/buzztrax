/* $Id: machine-rename-dialog-methods.h,v 1.1 2007-07-20 13:49:24 ensonic Exp $
 *
 * Buzztard
...
#ifndef BT_MACHINE_RENAME_DIALOG_METHODS_H
#define BT_MACHINE_RENAME_DIALOG_METHODS_H
