/* $Id: settings-page-interaction-controller-methods.h,v 1.1 2007-03-17 22:50:19 ensonic Exp $
 *
 * Buzztard
...
#ifndef BT_SETTINGS_PAGE_INTERACTION_CONTROLLER_METHODS_H
#define BT_SETTINGS_PAGE_INTERACTION_CONTROLLER_METHODS_H
