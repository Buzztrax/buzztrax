...
#define MACHINE_VIEW_SIZE_X (400.0*2.0)
#define MACHINE_VIEW_SIZE_Y (300.0*2.0)

#define ICON_UPSAMPLING 1.5
// icon box
#define MACHINE_SIZE_X (48.0*ICON_UPSAMPLING)
#define MACHINE_SIZE_Y (38.0*ICON_UPSAMPLING)
// label box
#define MACHINE_LABEL_BASE (15.0*ICON_UPSAMPLING)
...
#define WIRE_PAD_SIZE_X (35.0*ICON_UPSAMPLING)
#define WIRE_PAD_SIZE_Y (18.0*ICON_UPSAMPLING)
