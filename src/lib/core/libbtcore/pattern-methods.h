/* $Id: pattern-methods.h,v 1.5 2004-12-06 20:18:49 waffel Exp $
...
extern gulong bt_pattern_get_global_dparam_index(const BtPattern *self, const gchar *name);
extern gulong bt_pattern_get_voice_dparam_index(const BtPattern *self, const gchar *name);
