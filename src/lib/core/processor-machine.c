/** $Id: processor-machine.c,v 1.1 2004-05-07 18:04:14 ensonic Exp $
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (property_id) {
    default: { // call super method
			BtProcessorMachineClass *klass=BT_PROCESSOR_MACHINE_GET_CLASS(object);
  ...
  if (type == 0) {
    static const GTypeInfo info = {
      ...
      0,   // n_preallocs
		...
		type = g_type_register_static(BT_MACHINE_TYPE,"BtProcessorMachineType",&info,0);
  }
  return type;
}
